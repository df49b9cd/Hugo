...
{
    [Fact]
    public void Map_ComposesFunctionApplication()
    {
    Check.QuickThrowOnFailure(Prop.ForAll<int>(value =>
        {
    ...
    [Fact]
    public void Recover_ShouldNotRun_WhenResultIsSuccess()
    {
    Check.QuickThrowOnFailure(Prop.ForAll<int>(value =>
        {
    ...
    [Fact]
    public void Ensure_ShouldFailForOddValues()
    {
    Check.QuickThrowOnFailure(Prop.ForAll<int>(value =>
        {
            ...
            if (value % 2 == 0)
            {
                return ensured.IsSuccess && ensured.Value == value;
            }
    ...
    [Fact]
    public void Sequence_ShouldAccumulate_OnSuccess()
    {
    Check.QuickThrowOnFailure(Prop.ForAll<int[]>(values =>
        {
    ...
    [Fact]
    public void Recover_ShouldRehydrateFailure()
    {
    Check.QuickThrowOnFailure(Prop.ForAll<NonEmptyString>(message =>
        {
